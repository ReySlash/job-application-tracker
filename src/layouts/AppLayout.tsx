...
function AppLayout() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      >
        <img
          className={`${sidebar ? "h-6" : "h-8"} hover:scale-110 transition-all duration-300 ease-in-out hover:cursor-pointer`}
      ...
      <aside
        aria-hidden={!sidebar}
        className={`fixed left-0 top-0 z-30 h-full w-64 overflow-hidden border-r border-gray-200 bg-gray-50 shadow-sm transition-transform duration-300 ease-in-out ${
